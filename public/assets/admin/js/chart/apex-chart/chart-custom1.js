...
if (document.querySelector('#bar-chart-earning') && !window.__adminEarningChart) {
...
if (document.querySelector('#report-chart') && !window.__adminRevenueChart) {
...
if (document.querySelector('#pie-chart-visitors') && !window.__adminVisitorsChart) {
