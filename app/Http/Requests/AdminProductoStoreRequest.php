...
class AdminProductoStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'Prod_Slug' => ['required', 'string', 'max:200', 'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/', 'unique:tb_producto,Prod_Slug'],
    ...
    public function messages(): array
    {
        return [
            ...
            'Stock.required' => 'Indica el stock inicial.',
