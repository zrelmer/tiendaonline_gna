    <footer class="section-t-space footer-section-2">
        <div class="container-fluid-lg">
                    ...
                    <div class="service-contain">
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                <h5>Componentes de última generación</h5>
                            </div>
                        </div>
                        ...
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                            <h5>Envío gratis en pedidos de Q300 o más</h5>
                            </div>
                        </div>
                        ...
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                <h5>Ofertas tecnológicas diarias</h5>
                            </div>
                        </div>
            ...
            <div class="main-footer pt-2" style="border-top: 2px dashed #dee2e6;">
                <div class="row g-md-4 gy-sm-5 gy-2">
                    <div class="col-xxl-3 col-xl-4 col-sm-6">
                        ...
                        <ul class="social-icon">
                            ...
                            <li>
                                <a href="https://wa.me/message/WY5TQ7VBFPUVP1" target="_blank">
                                    <i class="fab fa-whatsapp"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.tiktok.com/@gna.core" target="_blank">
